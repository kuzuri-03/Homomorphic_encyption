...
import function_for_FHE as rlwe_updated
import numpy as np
...
if __name__ == '__main__':
    ...
    print("[+] pt1 + {} + {} * pt2): {}".format(cst1, cst2, rlwe_updated.polyadd(rlwe_updated.polyadd(pt1, cst1, t, poly_mod),rlwe_updated.polymul(cst2, pt2, t ,poly_mod), t, poly_mod)))
